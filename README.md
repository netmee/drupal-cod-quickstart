...
(for running scheduled tasks).
    ...
    rhc app create drupalcod php-5.4 postgresql-9.2 cron
...
Create a php-5.4 application with PostgreSQL and Cron support.
    ...
    rhc app create drupalcod php-5.4 postgresql-9.2 cron --from-code=git://github.com/netmee/drupal-cod-quickstart

That's it, you can now checkout your application at:
    http://drupalcod-$yournamespace.rhcloud.com
